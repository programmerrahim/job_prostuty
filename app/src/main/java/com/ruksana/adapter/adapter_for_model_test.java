...
public class adapter_for_model_test extends RecyclerView.Adapter<adapter_for_model_test.myviewholder>
{
   ArrayList<Model_Firestore_Database> datalist;

    public adapter_for_model_test(ArrayList<Model_Firestore_Database> datalist) {
