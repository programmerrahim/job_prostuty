...
public class PrimaryQuestionBankActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(PrimaryQuestionBankActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("Primary Question Bank");
