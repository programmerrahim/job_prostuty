...
public class PrimaryPracticeActivity extends AppCompatActivity {
    ...
    adapter_for_practice adapter_for_practice;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(PrimaryPracticeActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("Primary Practice");
