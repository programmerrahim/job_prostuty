...
public class BcsQuestionBankActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(BcsQuestionBankActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("Bcs Question Bank");
