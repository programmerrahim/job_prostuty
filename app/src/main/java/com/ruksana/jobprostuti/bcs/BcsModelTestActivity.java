...
public class BcsModelTestActivity extends AppCompatActivity {
    ...
    com.ruksana.adapter.adapter_for_model_test adapter_for_model_test;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(new LinearLayoutManager(BcsModelTestActivity.this));
    ...
    private void actionBar() {
        ...
        actionBar.setTitle("Bcs Model Test");
